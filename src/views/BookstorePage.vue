<!-- This can serve as inspiration, for the way of: -->
<!---->
<!-- - modifying a property of an object -->
<!-- - toggle favourites & its styles -->
<!---->
<!-- Look up books, information about them (and their tags, tropes, genres, triggers), read synopsyses, -->
<!-- opinions. -->

<script>
export default {
  //data, functions, etc
  // template: `<h2>i am the tdsfdsemplate ${data} </h2>`,
  data() {
    return {
    ...
    <ul class="books">
      ...
      >
        ...
        <div v-show="showButtons" class="buttons">
          ...
          <button @click="changeTitle('Cursus Pottenbakken, the sequel', book)">Ander?</button>
        </div>
      </li>
    </ul>
  </div>
