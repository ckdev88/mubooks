<script>
import MuBooksOverviewStatsBestsellers from '/src/components/MuBooksOverviewStatsBestsellers.vue'
import MuBooksOverviewStatsRecent from '/src/components/MuBooksOverviewStatsRecent.vue'
import MuBooksOverviewStatsSmallChapters from '/src/components/MuBooksOverviewStatsSmallChapters.vue'
import MuBooksOverviewStatsBigBooks from '/src/components/MuBooksOverviewBigBooks.vue'
...
<template>
	<div>
		...
		<p>
			...
			<MuBooksOverviewStatsSmallChapters
				:amountBooksSmallChapters="amountBooksSmallChapters"
			/>
